...
# im1 = cv2.imread('../images/suavizante/suavizante.jpg')
# im1 = cv2.imread('../images/suavizante/suavitel.png')
im1 = cv2.imread('./Suavizante/suavitel.jpeg')
ancho = int(im1.shape[1]/3)
alto = int(im1.shape[0]/3)
...
print(descriptor1, keypoint1)

# Drawing the keypoints
kp_image = cv2.drawKeypoints(im1, keypoint1, None, color=(0, 255, 0), flags=0)
