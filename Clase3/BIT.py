...
# IMAGENES
img1 = cv2.imread('./Clase3/img1.png', 0)
img2 = cv2.imread('./Clase3/img2.png', 0)
...
# APLICACION CON IMG
imglogo = cv2.imread('./Clase3/logo.png')
imgback = cv2.imread('./Clase3/fondo.png')
...
ret, imgmask = cv2.threshold(logogray, 127, 255, cv2.THRESH_BINARY)
