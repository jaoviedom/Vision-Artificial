...
# img = cv2.imread('./Clase3/monedas.jpg')
img = cv2.imread('./Clase3/monedas2.jpeg')
...
ret, imgthresh1 = cv2.threshold(brillantegray, 160, 255, cv2.THRESH_BINARY)

ret, imgthresh2 = cv2.threshold(brillantegray, 180, 255, cv2.THRESH_BINARY_INV)
